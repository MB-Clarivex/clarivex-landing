      ...
      <div className="container mx-auto max-w-7xl relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full text-blue-300 text-sm font-medium"
          >
            <Sparkles className="w-4 h-4" />
            <span>AI platforma, kuri supranta lietuviškai</span>
          </motion.div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Postas sukurtas</p>
            </div>
            <div className="w-px bg-gray-700 hidden sm:block" />
            <div className="text-center">
              <p className="text-3xl font-bold text-white">24/7</p>
              <p className="text-sm text-gray-400">Visada pasiruošęs</p>
            </div>
            <div className="w-px bg-gray-700 hidden sm:block" />
            <div className="text-center">
              <p className="text-3xl font-bold text-white">100+</p>
              <p className="text-sm text-gray-400">Kalbų</p>
            </div>
          </motion.div>
